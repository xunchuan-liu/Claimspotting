...
def main(day=date.today().strftime("%Y-%m-%d")):
    ...
    response = requests.get("https://api.govinfo.gov/collections/CREC/" + startDate,
                            params=packageParameters)  # Gets a list of Congressional Record issues given the date
